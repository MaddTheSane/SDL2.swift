...
public typealias SDL_TexturePtr = OpaquePointer
public typealias SDL_RendererPtr = OpaquePointer
public typealias SDL_GameControllerPtr = OpaquePointer
public typealias SDL_WindowPtr = OpaquePointer
public typealias SDL_ThreadPtr = OpaquePointer
...
public var SDL_WINDOWPOS_CENTERED: Int32 {
	return Int32(SDL_WINDOWPOS_CENTERED_DISPLAY(0))
}
